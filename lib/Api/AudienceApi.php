...
class AudienceApi
{
     ...
     *
     * @param  \Criteo\Marketing\Model\NewAudienceRequest $new_audience_request new_audience_request (required)
     *
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Criteo\Marketing\Model\NewAudienceResponse|\Criteo\Marketing\Model\ErrorCodeResponse
     */
     ...
     *
     * @param  \Criteo\Marketing\Model\NewAudienceRequest $new_audience_request (required)
     *
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Criteo\Marketing\Model\NewAudienceResponse|\Criteo\Marketing\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAudienceWithHttpInfo($new_audience_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Criteo\Marketing\Model\NewAudienceResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Criteo\Marketing\Model\NewAudienceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
                    if ('\Criteo\Marketing\Model\ErrorCodeResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Criteo\Marketing\Model\ErrorCodeResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Criteo\Marketing\Model\NewAudienceResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Criteo\Marketing\Model\NewAudienceResponse',
                ...
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Criteo\Marketing\Model\ErrorCodeResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    protected function createAudienceRequest($new_audience_request)
    {
        ...
        if (isset($new_audience_request)) {
            $_tempBody = $new_audience_request;
        }
     ...
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Criteo\Marketing\Model\DeleteAudienceContactListResponse|\Criteo\Marketing\Model\ErrorCodeResponse
     */
     ...
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Criteo\Marketing\Model\DeleteAudienceContactListResponse|\Criteo\Marketing\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteIdentifiersWithHttpInfo($audience_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Criteo\Marketing\Model\DeleteAudienceContactListResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Criteo\Marketing\Model\DeleteAudienceContactListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Criteo\Marketing\Model\DeleteAudienceContactListResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Criteo\Marketing\Model\DeleteAudienceContactListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteIdentifiersRequest($audience_id)
    {
     ...
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Criteo\Marketing\Model\GetAudiencesResponse|\Criteo\Marketing\Model\ErrorCodeResponse
     */
     ...
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Criteo\Marketing\Model\GetAudiencesResponse|\Criteo\Marketing\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAudiencesWithHttpInfo($advertiser_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Criteo\Marketing\Model\GetAudiencesResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Criteo\Marketing\Model\GetAudiencesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Criteo\Marketing\Model\GetAudiencesResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Criteo\Marketing\Model\GetAudiencesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $audience_id The id of the audience to amend (required)
     * @param  \Criteo\Marketing\Model\ReplaceAudienceRequest $replace_audience_request replace_audience_request (required)
     *
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Criteo\Marketing\Model\ReplaceAudienceResponse|\Criteo\Marketing\Model\ErrorCodeResponse
     */
     ...
     *
     * @param  string $audience_id The id of the audience to amend (required)
     * @param  \Criteo\Marketing\Model\ReplaceAudienceRequest $replace_audience_request (required)
     *
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Criteo\Marketing\Model\ReplaceAudienceResponse|\Criteo\Marketing\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyAudienceWithHttpInfo($audience_id, $replace_audience_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Criteo\Marketing\Model\ReplaceAudienceResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Criteo\Marketing\Model\ReplaceAudienceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Criteo\Marketing\Model\ReplaceAudienceResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Criteo\Marketing\Model\ReplaceAudienceResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function modifyAudienceRequest($audience_id, $replace_audience_request)
    {
        // verify the required parameter 'audience_id' is set
        if ($audience_id === null || (is_array($audience_id) && count($audience_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($replace_audience_request)) {
            $_tempBody = $replace_audience_request;
        }
     ...
     *
     * @param  string $audience_id The id of the audience to amend (required)
     * @param  \Criteo\Marketing\Model\ContactlistAmendmentRequest $contactlist_amendment_request contactlist_amendment_request (required)
     *
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Criteo\Marketing\Model\ModifyAudienceResponse|\Criteo\Marketing\Model\ErrorCodeResponse|\Criteo\Marketing\Model\ErrorCodeResponse
     */
     ...
     *
     * @param  string $audience_id The id of the audience to amend (required)
     * @param  \Criteo\Marketing\Model\ContactlistAmendmentRequest $contactlist_amendment_request (required)
     *
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Criteo\Marketing\Model\ModifyAudienceResponse|\Criteo\Marketing\Model\ErrorCodeResponse|\Criteo\Marketing\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyAudienceUsersWithHttpInfo($audience_id, $contactlist_amendment_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Criteo\Marketing\Model\ModifyAudienceResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Criteo\Marketing\Model\ModifyAudienceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Criteo\Marketing\Model\ModifyAudienceResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Criteo\Marketing\Model\ModifyAudienceResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Criteo\Marketing\Model\DeleteAudienceResponse|\Criteo\Marketing\Model\ErrorCodeResponse
     */
     ...
     * @throws \Criteo\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Criteo\Marketing\Model\DeleteAudienceResponse|\Criteo\Marketing\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function removeAudienceWithHttpInfo($audience_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Criteo\Marketing\Model\DeleteAudienceResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Criteo\Marketing\Model\DeleteAudienceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Criteo\Marketing\Model\DeleteAudienceResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Criteo\Marketing\Model\DeleteAudienceResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function removeAudienceRequest($audience_id)
    {
        // verify the required parameter 'audience_id' is set
        if ($audience_id === null || (is_array($audience_id) && count($audience_id) === 0)) {
            throw new \InvalidArgumentException(
